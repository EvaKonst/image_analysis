...
subplot(1, 2, 1);
imshow(I, []);
caption = sprintf('Image Before HSI Adaptive Histogram Equalization');
title(caption);
...
intensity = adapthisteq(intensity);
...
subplot(1, 2, 2);
imshow(I, []);
caption = sprintf('Image After HSI Adaptive Histogram Equalization');
title(caption);
